...
class StockSnapshotTest < ActiveSupport::TestCase
  ...
  test "is_conservatively_financed" do
    ...
    assert stock_snapshots(:adm).is_conservatively_financed == false
  ...
  test "satisfies_fundamental_rules" do
    ...
    assert stock_snapshots(:adm).satisfies_fundamental_rules == false
  end
  ...
  test "sell?" do
    ...
    assert stock_snapshots(:adm).sell? == true
  end
end
